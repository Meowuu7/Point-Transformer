...
if __name__ == '__main__':
    ...
    if args.dataparallel:
        from trainer.cls_trainer_hvd import TrainerClassification
    else:
    ...
    # --use_sgd --num_fea=6 --device=6 --batch_size=16 --dp_ratio=0.2 --attn_mult=1 --use_abs_pos --with_normal
    ...
    trainer = TrainerClassification(dataset_root="./data/modelnet40_normal_resampled",
                                    num_points=1024,
